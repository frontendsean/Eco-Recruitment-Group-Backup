...
<head>
	<title>Eco Recruitment Group - Worth Knowing</title>
...
<div class="container">
	<div class="sixteen columns">
		...
		<!-- Logo -->
		<a href="http://www.ecorecruitmentgroup.com">
		<div id="logo">
			 <?php
                ...
                if($logo) {
                    if(is_front_page()){ ?>
                    <a href="http://www.ecorecruitmentgroup.com" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home"><img src="<?php echo esc_url($logo); ?>" data-rjs="<?php echo esc_url($logo_retina); ?>" alt="<?php esc_attr(bloginfo('name')); ?>"/></a>
                    <?php } else { ?>
