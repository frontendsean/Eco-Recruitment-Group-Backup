jQuery( document ).ready( function ( $ ) {
	...
	$( '.resumes' ).on( 'update_results', function( event, page, append ) {
		...
		var results  = $( '.columns:not(.sidebar) ul.resumes' );
  ...
  /* rate slider */
	...
	$( '#search_keywords, #search_location,  #search_radius, .radius_type, #search_categories, #search_skills, .filter_by_check' ).change( function() {
